...
En la monografía de grado, se deben articular los
...
finalizar este seminario se deberá obtener la aprobación del
proyecto de tesis del profesor o profesora que vaya a dirigir el
trabajo.


**Docente**:
[Juan Camilo Espejo-Serna](../index.html)\
**Horario:** Miércoles 1:00 - 4:00 pm.\
...
virtual a más tardar el *72 horas antes de la sesión*. Todos los
...
Por eso, todos tienen una entrega "de gracia". Es decir, pueden dejar de entregar algo sin problema; por ejemplo, la primera reseña que les falte no cuenta. Por ejemplo, si no entregan algo una semana y entregan todos los demás, su nota igual queda en 5.0.</p>
